...
class HomeDao implements HomeDaoInterface
{
    ...
    {
        $productList = Product::with('category')->inRandomOrder()->take(8)->orderBy('created_at', 'DESC')->get();
        return $productList;
    }
    ...
    {
        $productList = Product::where('category_id', $category_id)->paginate(4);
        return $productList;
    }
    ...
    {
        $feedbackList = Review::inRandomOrder()->paginate(2);
        return $feedbackList;
    }
}