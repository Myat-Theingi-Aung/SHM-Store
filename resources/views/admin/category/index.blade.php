                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-div">
                            ...
                            <form class="col1 categoryDeleteForm{{$category->id}}" action="{{ route('admin.category.delete',$category->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="button">
                                    <a href="javascript:;" data-id="{{ $category->id }}" class="del-category-btn">
