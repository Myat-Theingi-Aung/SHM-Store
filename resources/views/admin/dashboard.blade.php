        ...
        <div class="col-up">
            <div class="card-up">
                <div class="card-body-up clearfix">
                    ...
                    <div class="txt">
                        <h4 class="cmn-h4"><span class="counter-up">{{ $users }}</span></h4>
                        <p>Total Users</p>
                    </div>                   
                </div>
            </div>
        ...
        <div class="col-up">
            <div class="card-up">
                <div class="card-body-up clearfix">
                    ...
                    <div class="txt">
                        <h4 class="cmn-h4"><span class="counter-up">{{ $orders }}</span></h4>
                        <p>Total Orders</p>
                    </div>                   
                </div>
            </div>
        ...
        <div class="col-up">
            <div class="card-up">
                <div class="card-body-up clearfix">
                    ...
                    <div class="txt">
                        <h4 class="cmn-h4"><span class="counter-up">{{ $products }}</span></h4>
                        <p>Total Products</p>
                    </div>                   
                </div>
            </div>
        ...
        <div class="col-up">
            <div class="card-up">
                <div class="card-body-up clearfix">
                    ...
                    <div class="txt">
                        <h4 class="cmn-h4"><span class="counter-up">{{ $categories }}</span></h4>
