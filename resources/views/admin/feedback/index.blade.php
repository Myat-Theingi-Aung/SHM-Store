...
@section('title')SHM Store | Feedback List @endsection
<link rel="stylesheet" href="{{ asset('backend/css/product.css') }}">
@section('content')
<div class="card">
    <div class="card-body">
        <div class="ttl clearfix">
            <h3 class="cmn-h3">Feedback List</h3>
        </div>
        <hr>
        <table>
            <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-div">                            
                            <form class="col1 feedbackDeleteForm{{$feedback->id}}" action="{{ route('admin.feedback.delete',$feedback->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="button">
                                    <a href="javascript:;" data-id="{{ $feedback->id }}" class="del-feedback-btn">
