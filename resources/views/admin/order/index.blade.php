...
@section('title')SHM Store | Show Order List @endsection
...
<div class="card">
    <div class="card-body">
        <div class="ttl clearfix">
            <h3 class="cmn-h3">Order List</h3>
            <button class="cmn-btn cpt-order-btn"><a href="{{ route('admin.order.completedOrder') }}">Completed Order</a></button>
            <button class="cmn-btn"><a href="{{ route('admin.order.pendingOrder') }}">Pending Order</a></button>
