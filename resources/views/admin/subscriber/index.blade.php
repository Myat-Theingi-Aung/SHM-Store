...
@section('title')SHM Store | Show Subscriber List @endsection
...
<div class="card">
    <div class="card-body">
        <div class="ttl clearfix">
            <h3 class="cmn-h3">Subscriber List</h3>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-div">
                            ...
                            <form class="col1 subscriberDeleteForm{{$s->id}}" action="{{ route('admin.subscriber.delete',$s->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                    <button type="button">
                                        <a href="javascript:;" data-id="{{ $s->id }}" class="del-subscriber-btn">
