    ...
    <div class="cart-mv">
      ...
      <div class="table-box">
            ...
            <tr>
              ...
              <td>
                <div class="qty-box clearfix">
                  <a href="" class="update-cart minus">&minus;</a>
                  <input type="number" disabled class="qty" value="10">
                  <a href="" class="update-cart plus">&plus;</a>
                </div>
              </td>
              <td></td>
              <td></td>
              <td>
                <a href=""><svg class="del-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        ...
        <div class="cart-table clearfix  ">
          <div class="btn-blk ">
            <a href="" class="cart-btn back">BACK</a>
            <a href="" class="cart-btn clear">CLEAR</a>
